...
import json
import subprocess
from transcript.lista_videos import videos, curso, videos_listados
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        # Indice para numerar os arquivos
        indiceFile = 0
            ...
            for topico in curso['topicos']:
                ...
                for subTopico in topico['subtopicos']:
                    ...
                    arquivo_saida = (
                        ...
                        f"transcript/transcricoes_{indiceFile:02d}.json"
                    )    
                    ...
                    print(f"\nTrecho {indiceFile:02d} salvo em:\n{arquivo_saida}")
        ...
        arquivo_saida = (
            Path(__file__).parent /
            "transcript/lista_videos_curso.json"
        )  
